...
export function GearIcon({ className = DEFAULT }: IconProps) {
  return (
    <svg {...svgProps(className)}>
      <circle cx="12" cy="12" r="3" />
...
export function MonitorIcon({ className = DEFAULT }: IconProps) {
  return (
    <svg {...svgProps(className)}>
...
export function SunIcon({ className = DEFAULT }: IconProps) {
  return (
    <svg {...svgProps(className)}>
...
export function MoonIcon({ className = DEFAULT }: IconProps) {
  return (
    <svg {...svgProps(className)}>
